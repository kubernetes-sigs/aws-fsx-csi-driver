...
// Source: sigs.k8s.io/aws-fsx-csi-driver/pkg/cloud (interfaces: MetadataService)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=./pkg/cloud/mocks/mock_metadata.go --build_flags=--mod=mod sigs.k8s.io/aws-fsx-csi-driver/pkg/cloud MetadataService
//
